    ...
    <div class="container-fluid"  style="height: 100%; min-height: 82.7vh;">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          ...
          <div class="card my-5">
            <form action="process/aprocess.php" method="POST" class="card-body cardbody-color p-lg-5">
              <div class="text-center">
                <img src="assets/admin.png" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-3"
              ...
              <div class="text-center"><button type="submit" type="submit"class="btn btn-primary" value="Login">Login</button></div>
            </form>
          </div>
        </div>
      </div>
